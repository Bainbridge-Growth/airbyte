            ...
            if row_type == "Section":
                ...
                for col_index, value_field, id_field in column_specs:
                    if col_index >= len(col_data):
                        record[value_field] = None if value_field == "Amount" else ""
                        if id_field:
                            record[id_field] = ""
                        continue
                    ...
                    if value_field == "TxDate":
                        ...
                        if value == "":
                            ...
                            try:
                                ...
                                self.logger.warning(f"Unparseable Amount value {value!r}, dropping row")
                                value = None
                ...
                # `is None` (not falsy) so legitimate $0.00 transactions still come through.
